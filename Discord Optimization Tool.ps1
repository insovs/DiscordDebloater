    ...
    <Grid>
      ...
      <Border Grid.Row="0" x:Name="TitleBar"
        ...
        <Grid Margin="16,0,10,0">
          <StackPanel Orientation="Horizontal" VerticalAlignment="Center" Height="46">
          </StackPanel>
        ...
        <StackPanel>
          ...
          <StackPanel HorizontalAlignment="Center" Margin="0,0,0,28">
            <Image Source="https://raw.githubusercontent.com/insovs/credits/main/Optimizer.png"
                   Width="130" Height="130" VerticalAlignment="Center" Margin="0,0,0,12"/>
            ...
            <TextBlock Foreground="#4e5058" FontSize="11.5" TextAlignment="Center"
                       ...
                       LineHeight="20"
                       Text="An easy-to-use tool for removing unnecessary files, modules, caches, and resource-intensive features to significantly reduce Discord's RAM and CPU usage."/>
          </StackPanel>
          ...
          <Grid Margin="0,0,0,0">
            ...
            <Button Grid.Column="0" x:Name="BtnOpenDebloat" Style="{StaticResource CardBtn}" Padding="20">
              <StackPanel>
                ...
                <TextBlock Foreground="#6b7280" FontSize="10.5" TextWrapping="Wrap" LineHeight="16" Margin="0,0,0,12"
                ...
                <WrapPanel>
                  <Border CornerRadius="4" Margin="0,0,4,4" Padding="7,2" Background="#1a1b1e" BorderBrush="#2e3035" BorderThickness="1">
                    <TextBlock Text="modules" Foreground="#6b7280" FontSize="9" FontFamily="Consolas"/>
                  </Border>
                  <Border CornerRadius="4" Margin="0,0,4,4" Padding="7,2" Background="#1a1b1e" BorderBrush="#2e3035" BorderThickness="1">
                    <TextBlock Text="lang packs" Foreground="#6b7280" FontSize="9" FontFamily="Consolas"/>
                  </Border>
                  <Border CornerRadius="4" Margin="0,0,4,4" Padding="7,2" Background="#1a1b1e" BorderBrush="#2e3035" BorderThickness="1">
                    <TextBlock Text="krisp" Foreground="#6b7280" FontSize="9" FontFamily="Consolas"/>
                  </Border>
                  <Border CornerRadius="4" Padding="7,2" Background="#1a1b1e" BorderBrush="#2e3035" BorderThickness="1">
                    <TextBlock Text="updater" Foreground="#6b7280" FontSize="9" FontFamily="Consolas"/>
                  </Border>
                  <Border CornerRadius="4" Margin="4,4,0,0" Padding="7,2" Background="#1a1b1e" BorderBrush="#2e3035" BorderThickness="1">
                    <TextBlock Text="autostart" Foreground="#6b7280" FontSize="9" FontFamily="Consolas"/>
                  </Border>
                  <Border CornerRadius="4" Margin="4,4,0,0" Padding="7,2" Background="#1a1b1e" BorderBrush="#2e3035" BorderThickness="1">
                    <TextBlock Text="FSO" Foreground="#6b7280" FontSize="9" FontFamily="Consolas"/>
                  </Border>
                </WrapPanel>
              </StackPanel>
            </Button>
            ...
            <Button Grid.Column="2" x:Name="BtnOpenSettings" Style="{StaticResource CardBtn}" Padding="20">
              <StackPanel>
                ...
                <WrapPanel>
                  <Border CornerRadius="4" Margin="0,0,4,4" Padding="7,2" Background="#1a1b1e" BorderBrush="#2e3035" BorderThickness="1">
                    <TextBlock Text="HW accel" Foreground="#6b7280" FontSize="9" FontFamily="Consolas"/>
                  </Border>
                  <Border CornerRadius="4" Margin="0,0,4,4" Padding="7,2" Background="#1a1b1e" BorderBrush="#2e3035" BorderThickness="1">
                    <TextBlock Text="dev mode" Foreground="#6b7280" FontSize="9" FontFamily="Consolas"/>
                  </Border>
                  <Border CornerRadius="4" Margin="0,0,4,4" Padding="7,2" Background="#1a1b1e" BorderBrush="#2e3035" BorderThickness="1">
                    <TextBlock Text="tray" Foreground="#6b7280" FontSize="9" FontFamily="Consolas"/>
                  </Border>
                  <Border CornerRadius="4" Padding="7,2" Background="#1a1b1e" BorderBrush="#2e3035" BorderThickness="1">
                    <TextBlock Text="debug log" Foreground="#6b7280" FontSize="9" FontFamily="Consolas"/>
                  </Border>
                </WrapPanel>
              </StackPanel>
            </Button>
            ...
            <Button Grid.Column="4" x:Name="BtnOpenCache" Style="{StaticResource CardBtn}" Padding="20">
              <StackPanel>
                ...
                <WrapPanel>
                  <Border CornerRadius="4" Margin="0,0,4,4" Padding="7,2" Background="#1a1b1e" BorderBrush="#2e3035" BorderThickness="1">
                    <TextBlock Text="cache" Foreground="#6b7280" FontSize="9" FontFamily="Consolas"/>
                  </Border>
                  <Border CornerRadius="4" Margin="0,0,4,4" Padding="7,2" Background="#1a1b1e" BorderBrush="#2e3035" BorderThickness="1">
                    <TextBlock Text="gpu cache" Foreground="#6b7280" FontSize="9" FontFamily="Consolas"/>
                  </Border>
                  <Border CornerRadius="4" Margin="0,0,4,4" Padding="7,2" Background="#1a1b1e" BorderBrush="#2e3035" BorderThickness="1">
                    <TextBlock Text="crashpad" Foreground="#6b7280" FontSize="9" FontFamily="Consolas"/>
                  </Border>
                  <Border CornerRadius="4" Padding="7,2" Background="#1a1b1e" BorderBrush="#2e3035" BorderThickness="1">
                    <TextBlock Text="sentry" Foreground="#6b7280" FontSize="9" FontFamily="Consolas"/>
                  </Border>
                </WrapPanel>
              </StackPanel>
            </Button>
      ...
      <Border Grid.Row="2" Background="#0e0f11" BorderBrush="#2a2c30" BorderThickness="0,1,0,0"
              CornerRadius="0,0,14,14" Padding="8,0">
        <Grid>
<Button x:Name="BtnAbout" HorizontalAlignment="Left" VerticalAlignment="Center"
        Background="#1e1f22" BorderBrush="#2e3035" BorderThickness="1"
        Cursor="Hand" Padding="12,4"
        WindowChrome.IsHitTestVisibleInChrome="True">
  <Button.Template>
    <ControlTemplate TargetType="Button">
      <Border x:Name="bd" Background="{TemplateBinding Background}"
              ...
              BorderThickness="{TemplateBinding BorderThickness}"
              CornerRadius="6" Padding="{TemplateBinding Padding}">
        <TextBlock x:Name="lnk" Text="more about this"
                   Foreground="#4e5058" FontSize="9" FontFamily="Consolas"/>
      </Border>
      <ControlTemplate.Triggers>
        <Trigger Property="IsMouseOver" Value="True">
          <Setter TargetName="bd" Property="BorderBrush" Value="#6b7280"/>
          <Setter TargetName="lnk" Property="Foreground" Value="#9ca3af"/>
        </Trigger>
      </ControlTemplate.Triggers>
    </ControlTemplate>
  </Button.Template>
      ...
      <Grid x:Name="ModalOverlay" Grid.Row="0" Grid.RowSpan="3"
          ...
          <Grid>
              ...
              <Grid>
                <StackPanel Orientation="Horizontal">
                  ...
                  <StackPanel VerticalAlignment="Center">
                    ...
                    <TextBlock x:Name="DbSelectedVariant" Text="Removes unused modules, old versions and heavy files" Foreground="#6b7280" FontSize="10" Margin="0,3,0,0"/>
                  </StackPanel>
                </StackPanel>
                <StackPanel Orientation="Horizontal" HorizontalAlignment="Right" VerticalAlignment="Center">
            ...
            <ScrollViewer Grid.Row="1" x:Name="DbPage1Scroll" VerticalScrollBarVisibility="Auto" Padding="24,20,24,4">
              <StackPanel x:Name="DbPage1">
                ...
                <TextBlock Text="LANGUAGE PACK TO KEEP" Foreground="#4e5058" FontSize="9"
                ...
                <Grid Margin="0,0,0,14">
                  ...
                  <RadioButton x:Name="RdLangEN" Grid.Column="0" Style="{StaticResource LangRadio}" GroupName="Lang" IsChecked="True">
                    <StackPanel HorizontalAlignment="Center">
                      ...
                      <TextBlock Text="en-US" HorizontalAlignment="Center" FontSize="9.5" Foreground="#6b7280" FontFamily="Consolas" Margin="0,3,0,0"/>
                    </StackPanel>
                  </RadioButton>
                  <RadioButton x:Name="RdLangFR" Grid.Column="2" Style="{StaticResource LangRadio}" GroupName="Lang">
                    <StackPanel HorizontalAlignment="Center">
                      ...
                      <TextBlock Text="fr-FR" HorizontalAlignment="Center" FontSize="9.5" Foreground="#6b7280" FontFamily="Consolas" Margin="0,3,0,0"/>
                    </StackPanel>
                  </RadioButton>
                  <RadioButton x:Name="RdLangBoth" Grid.Column="4" Style="{StaticResource LangRadio}" GroupName="Lang">
                    <StackPanel HorizontalAlignment="Center">
                      ...
                      <TextBlock Text="en + fr" HorizontalAlignment="Center" FontSize="9.5" Foreground="#6b7280" FontFamily="Consolas" Margin="0,3,0,0"/>
                    </StackPanel>
                  </RadioButton>
                </Grid>
              </StackPanel>
        ...
        <Border x:Name="PanelSettings" Visibility="Collapsed"
          ...
          <Grid>
              ...
              <Grid>
                <StackPanel Orientation="Horizontal">
                  ...
                  <StackPanel VerticalAlignment="Center">
                    ...
                    <TextBlock Text="Applies optimized settings.json: HW accel, logging, startup" Foreground="#6b7280" FontSize="10" Margin="0,3,0,0"/>
                  </StackPanel>
                </StackPanel>
            ...
            <ScrollViewer Grid.Row="2" x:Name="StPagePreview" VerticalScrollBarVisibility="Auto" Padding="24,20,24,4">
              <StackPanel>
                <TextBlock Text="WHAT WILL BE APPLIED" Foreground="#4e5058" FontSize="9"
                           FontFamily="Consolas" FontWeight="Bold" Margin="0,0,0,10"/>
                  ...
                  <StackPanel>
                    <Grid Margin="14,12,14,12">
                      <StackPanel>
                        ...
                        <TextBlock Text="Reduces GPU usage, better CPU performance on most systems" Foreground="#6b7280" FontSize="10" Margin="0,2,0,0"/>
                      </StackPanel>
                    ...
                    <Grid Margin="14,12,14,12">
                      <StackPanel>
                        ...
                        <TextBlock Text="Exposes additional debugging tools in Discord" Foreground="#6b7280" FontSize="10" Margin="0,2,0,0"/>
                      </StackPanel>
                      <Border HorizontalAlignment="Right" VerticalAlignment="Center" Width="34" Height="18" CornerRadius="9" Background="#3d4045" BorderBrush="#4b4d52" BorderThickness="1">
                        <Ellipse Width="12" Height="12" Fill="White" HorizontalAlignment="Right" Margin="0,0,2,0"/>
                      </Border>
                    ...
                    <Grid Margin="14,12,14,12">
                      <StackPanel>
                        ...
                        <TextBlock Text="Prevents automatic update checks on launch" Foreground="#6b7280" FontSize="10" Margin="0,2,0,0"/>
                      </StackPanel>
                      <Border HorizontalAlignment="Right" VerticalAlignment="Center" Width="34" Height="18" CornerRadius="9" Background="#3d4045" BorderBrush="#4b4d52" BorderThickness="1">
                        <Ellipse Width="12" Height="12" Fill="White" HorizontalAlignment="Right" Margin="0,0,2,0"/>
                      </Border>
                    ...
                    <Grid Margin="14,12,14,12">
                      <StackPanel>
                        ...
                        <TextBlock Text="Discord hides to tray instead of closing" Foreground="#6b7280" FontSize="10" Margin="0,2,0,0"/>
                      </StackPanel>
                      <Border HorizontalAlignment="Right" VerticalAlignment="Center" Width="34" Height="18" CornerRadius="9" Background="#3d4045" BorderBrush="#4b4d52" BorderThickness="1">
                        <Ellipse Width="12" Height="12" Fill="White" HorizontalAlignment="Right" Margin="0,0,2,0"/>
                      </Border>
                    ...
                    <Grid Margin="14,12,14,12">
                      <StackPanel>
                        ...
                        <TextBlock Text="Stops writing verbose debug logs to disk" Foreground="#6b7280" FontSize="10" Margin="0,2,0,0"/>
                      </StackPanel>
                      <Border HorizontalAlignment="Right" VerticalAlignment="Center" Width="34" Height="18" CornerRadius="9" Background="#3d4045" BorderBrush="#4b4d52" BorderThickness="1">
                        <Ellipse Width="12" Height="12" Fill="White" HorizontalAlignment="Right" Margin="0,0,2,0"/>
                      </Border>
                    ...
                    <Grid Margin="14,12,14,12">
                      <StackPanel>
                        ...
                        <TextBlock Text="Maximized window, not minimized on start" Foreground="#6b7280" FontSize="10" Margin="0,2,0,0"/>
                      </StackPanel>
                      <Border HorizontalAlignment="Right" VerticalAlignment="Center" Width="34" Height="18" CornerRadius="9" Background="#3d4045" BorderBrush="#4b4d52" BorderThickness="1">
                        <Ellipse Width="12" Height="12" Fill="White" HorizontalAlignment="Right" Margin="0,0,2,0"/>
                      </Border>
            ...
            <ScrollViewer Grid.Row="2" x:Name="StPageJson" Visibility="Collapsed"
              ...
              <StackPanel>
                <Border CornerRadius="9" Background="#0e0f11" BorderBrush="#2e3035" BorderThickness="1" Padding="14,12">
                  <StackPanel>
                    <TextBlock x:Name="StJsonPath" Text="%APPDATA%\discord\settings.json" Foreground="#4e5058"
          ...
          <Grid>
              ...
              <Grid>
                <StackPanel Orientation="Horizontal">
                  ...
                  <StackPanel VerticalAlignment="Center">
                    ...
                    <TextBlock Text="Clears GPU cache, cookies, crashpad and tracking data" Foreground="#6b7280" FontSize="10" Margin="0,3,0,0"/>
                  </StackPanel>
                </StackPanel>
            ...
            <ScrollViewer Grid.Row="1" x:Name="CaPage1Scroll" VerticalScrollBarVisibility="Auto" Padding="24,20,24,4">
              <StackPanel x:Name="CaPage1">
                ...
                <TextBlock Text="WHAT WILL BE REMOVED" Foreground="#4e5058" FontSize="9"
                           FontFamily="Consolas" FontWeight="Bold" Margin="0,0,0,10"/>
                <Border CornerRadius="10" Background="#1e1f22" BorderBrush="#2e3035"
                  ...
                  <StackPanel>
                    <StackPanel Margin="14,12,14,12">
                      ...
                      <TextBlock Text="Cache / Code Cache / GPUCache / ShaderCache / VideoDecodeStats" Foreground="#6b7280" FontSize="10" Margin="0,3,0,0" TextWrapping="Wrap"/>
                    </StackPanel>
                    <Border Background="#16171a" Height="1" Margin="14,0"/>
                    <StackPanel Margin="14,12,14,12">
                      <TextBlock Text="Browser Data" Foreground="#b5bac1" FontSize="11" FontWeight="Medium"/>
                      <TextBlock Text="Cookies / Web Data / Databases / Session Storage" Foreground="#6b7280" FontSize="10" Margin="0,3,0,0" TextWrapping="Wrap"/>
                    </StackPanel>
                    <Border Background="#16171a" Height="1" Margin="14,0"/>
                    <StackPanel Margin="14,12,14,12">
                      <TextBlock Text="Logs and Crash Reports" Foreground="#b5bac1" FontSize="11" FontWeight="Medium"/>
                      <TextBlock Text="logs / Crashpad / debug / sentry error tracking" Foreground="#6b7280" FontSize="10" Margin="0,3,0,0" TextWrapping="Wrap"/>
                    </StackPanel>
                    <Border Background="#16171a" Height="1" Margin="14,0"/>
                    <StackPanel Margin="14,12,14,12">
                      <TextBlock Text="DRM and Tracking" Foreground="#b5bac1" FontSize="11" FontWeight="Medium"/>
                      <TextBlock Text="MediaFoundation / WidevineCdm / blob_storage / CacheStorage" Foreground="#6b7280" FontSize="10" Margin="0,3,0,0" TextWrapping="Wrap"/>
                    </StackPanel>
                  </StackPanel>
                </Border>
                <TextBlock Text="OPTIONAL" Foreground="#4e5058" FontSize="9"
                           FontFamily="Consolas" FontWeight="Bold" Margin="0,0,0,10"/>
                  ...
                  <Grid>
                    <CheckBox x:Name="ChkLocalStorage" Style="{StaticResource ModernCheck}" IsChecked="False">
                      <StackPanel>
                        ...
                        <TextBlock Text="You will need to sign in to Discord again after this" Foreground="#6b7280" FontSize="10" Margin="0,2,0,0"/>
                      </StackPanel>
                    </CheckBox>
        ...
        <Border x:Name="PanelAdvanced" Visibility="Collapsed"
          ...
          <Grid>
              ...
              <Grid>
                <StackPanel Orientation="Horizontal">
                  ...
                  <StackPanel VerticalAlignment="Center">
                    ...
                    <TextBlock Text="Select what to keep or remove" Foreground="#6b7280" FontSize="10.5" Margin="0,3,0,0"/>
                  </StackPanel>
                </StackPanel>
            ...
            <ScrollViewer Grid.Row="1" VerticalScrollBarVisibility="Auto" Padding="24,18,24,4">
              <StackPanel>
                <TextBlock Text="BACKUP" Foreground="#4e5058" FontSize="9"
                           FontFamily="Consolas" FontWeight="Bold" Margin="0,0,0,10"/>
                  ...
                  <Grid Margin="14,11,14,11">
                    <CheckBox x:Name="ChkAdvBackup" Style="{StaticResource ModernCheck}" IsChecked="False">
                      <StackPanel>
                        ...
                        <TextBlock Text="Saves a full copy of Discord to your Desktop" Foreground="#6b7280" FontSize="10" Margin="0,2,0,0"/>
                      </StackPanel>
                    </CheckBox>
                    <Border HorizontalAlignment="Right" VerticalAlignment="Center"
                ...
                <TextBlock Text="MODULES" Foreground="#4e5058" FontSize="9"
                           FontFamily="Consolas" FontWeight="Bold" Margin="0,0,0,10"/>
                <Border CornerRadius="10" Background="#1e1f22" BorderBrush="#2e3035" BorderThickness="1" Margin="0,0,0,14">
                  <StackPanel>
                    <Grid Margin="14,12,14,12">
                      <CheckBox x:Name="ChkAdvKrisp" Style="{StaticResource ModernCheck}" IsChecked="False">
                        <StackPanel>
                          ...
                          <TextBlock Text="Only if you use another noise-cancellation solution" Foreground="#6b7280" FontSize="10" Margin="0,2,0,0"/>
                        </StackPanel>
                      </CheckBox>
                    </Grid>
                    <Border Background="#16171a" Height="1" Margin="14,0"/>
                    <Grid Margin="14,12,14,12">
                      <CheckBox x:Name="ChkAdvGameSDK" Style="{StaticResource ModernCheck}" IsChecked="True">
                        <StackPanel>
                          ...
                          <TextBlock Text="discord_game_sdk_*.dll - safe to remove for most users" Foreground="#6b7280" FontSize="10" Margin="0,2,0,0"/>
                        </StackPanel>
                      </CheckBox>
                      <Border HorizontalAlignment="Right" VerticalAlignment="Center"
                              CornerRadius="4" Padding="6,2" Background="#1e1f22" BorderBrush="#3d4045" BorderThickness="1">
                    ...
                    <StackPanel Margin="14,12,14,12">
                      <CheckBox x:Name="ChkAdvGamePresence" Style="{StaticResource ModernCheck}" IsChecked="False">
                        <StackPanel>
                          ...
                          <TextBlock Text="Disables game detection and rich presence broadcasting" Foreground="#6b7280" FontSize="10" Margin="0,2,0,0"/>
                        </StackPanel>
                      </CheckBox>
                      <Border CornerRadius="6" Background="#100e04" BorderBrush="#2a2000" BorderThickness="1"
                        ...
                        <TextBlock Foreground="#b08838" FontSize="9.5" TextWrapping="Wrap" LineHeight="16"
                                   Text="Warning: required by some games to link accounts (e.g. FiveM). Removing it may prevent joining servers."/>
                      </Border>
                    </StackPanel>
                  </StackPanel>
                </Border>

                <TextBlock Text="FILES AND COMPONENTS" Foreground="#4e5058" FontSize="9"
                           FontFamily="Consolas" FontWeight="Bold" Margin="0,0,0,10"/>
                <Border CornerRadius="10" Background="#1e1f22" BorderBrush="#2e3035" BorderThickness="1" Margin="0,0,0,14">
                  <StackPanel>
                    <Grid Margin="14,12,14,12">
                      <CheckBox x:Name="ChkAdvUpdater" Style="{StaticResource ModernCheck}" IsChecked="True">
                        <StackPanel>
                          ...
                          <TextBlock Text="Update.exe, SquirrelSetup, RELEASES package" Foreground="#6b7280" FontSize="10" Margin="0,2,0,0"/>
                        </StackPanel>
                      </CheckBox>
                      <Border HorizontalAlignment="Right" VerticalAlignment="Center"
                              CornerRadius="4" Padding="6,2" Background="#1e1f22" BorderBrush="#3d4045" BorderThickness="1">
                    ...
                    <Grid Margin="14,12,14,12">
                      <CheckBox x:Name="ChkAdvAutostart" Style="{StaticResource ModernCheck}" IsChecked="True">
                        <StackPanel>
                          ...
                          <TextBlock Text="Remove registry Run keys and scheduled tasks" Foreground="#6b7280" FontSize="10" Margin="0,2,0,0"/>
                        </StackPanel>
                      </CheckBox>
                      <Border HorizontalAlignment="Right" VerticalAlignment="Center"
                              CornerRadius="4" Padding="6,2" Background="#1e1f22" BorderBrush="#3d4045" BorderThickness="1">
                    ...
                    <Grid Margin="14,12,14,12">
                      <CheckBox x:Name="ChkAdvFSO" Style="{StaticResource ModernCheck}" IsChecked="True">
                        <StackPanel>
                          ...
                          <TextBlock Text="Prevents Windows from overriding exclusive fullscreen" Foreground="#6b7280" FontSize="10" Margin="0,2,0,0"/>
                        </StackPanel>
                      </CheckBox>
                    </Grid>
                    <Border Background="#16171a" Height="1" Margin="14,0"/>
                    <Grid Margin="14,12,14,12">
                      <CheckBox x:Name="ChkAdvJunk" Style="{StaticResource ModernCheck}" IsChecked="True">
                        <StackPanel>
                          ...
                          <TextBlock Text=".sig files, Vulkan DLLs, SwiftShader, d3dcompiler, etc." Foreground="#6b7280" FontSize="10" Margin="0,2,0,0"/>
                        </StackPanel>
                      </CheckBox>
                    </Grid>
                  </StackPanel>
        ...
        <!-- PANEL ABOUT -->
        <Border x:Name="PanelAbout" Visibility="Collapsed"
                HorizontalAlignment="Center" VerticalAlignment="Center"
                Width="460"
                Background="#18191c" BorderBrush="#2e3035" BorderThickness="1"
                CornerRadius="16">
          ...
          <Grid>
            ...
            <Border Grid.Row="0" BorderBrush="#2e3035" BorderThickness="0,0,0,1"
              ...
              <Grid>
                <StackPanel Orientation="Horizontal">
                  ...
                  <StackPanel VerticalAlignment="Center">
                    <TextBlock Text="About this tool" Foreground="#e3e5e8" FontSize="14" FontWeight="SemiBold"/>
                    <TextBlock Text="Discord Debloat and Optimization Tool" Foreground="#6b7280" FontSize="10" Margin="0,3,0,0"/>
                  </StackPanel>
                </StackPanel>
                <Button x:Name="BtnCloseAbout" HorizontalAlignment="Right" VerticalAlignment="Center"
                        Style="{StaticResource ModalCloseBtn}" Content="x"/>
              </Grid>
            </Border>

            <ScrollViewer Grid.Row="1" VerticalScrollBarVisibility="Auto" Padding="24,20,24,4">
              <StackPanel>
                <TextBlock Foreground="#6b7280" FontSize="11" TextWrapping="Wrap"
                           LineHeight="19" Margin="0,0,0,20"
                           Text="A free, open-source PowerShell utility that removes everything Discord doesn't need — old versions, unused modules, junk files, and background processes that silently consume your RAM and CPU."/>
                <Border CornerRadius="10" Background="#1e1f22" BorderBrush="#2e3035"
                        BorderThickness="1" Margin="0,0,0,16">
                  <StackPanel>
                    <Grid Margin="14,13,14,13">
                      <Grid.ColumnDefinitions>
                        <ColumnDefinition Width="100"/>
                        <ColumnDefinition Width="*"/>
                      </Grid.ColumnDefinitions>
                      <TextBlock Grid.Column="0" Text="Debloat" Foreground="#b5bac1" FontSize="11"
                                 FontWeight="SemiBold" VerticalAlignment="Top"/>
                      <TextBlock Grid.Column="1" Foreground="#4e5058" FontSize="10.5"
                                 TextWrapping="Wrap" LineHeight="17" VerticalAlignment="Top"
                                 Text="Removes old versions, unused modules, Krisp, language packs, and junk files."/>
                    </Grid>
                    <Border Background="#16171a" Height="1" Margin="14,0"/>
                    <Grid Margin="14,13,14,13">
                      <Grid.ColumnDefinitions>
                      ...
                      <TextBlock Grid.Column="0" Text="Opt. Settings" Foreground="#b5bac1" FontSize="11"
                                 FontWeight="SemiBold" VerticalAlignment="Top"/>
                      <TextBlock Grid.Column="1" Foreground="#4e5058" FontSize="10.5"
                                 TextWrapping="Wrap" LineHeight="17" VerticalAlignment="Top"
                                 Text="Writes a performance-focused settings.json — disables hardware acceleration, auto-updates, and debug logging."/>
                    </Grid>
                    <Border Background="#16171a" Height="1" Margin="14,0"/>
                    <Grid Margin="14,13,14,13">
                      <Grid.ColumnDefinitions>
                      ...
                      <TextBlock Grid.Column="0" Text="Clean Cache" Foreground="#b5bac1" FontSize="11"
                                 FontWeight="SemiBold" VerticalAlignment="Top"/>
                      <TextBlock Grid.Column="1" Foreground="#4e5058" FontSize="10.5"
                                 TextWrapping="Wrap" LineHeight="17" VerticalAlignment="Top"
                                 Text="Clears GPU cache, cookies, crashpad, and Sentry tracking data to free disk space."/>
                    </Grid>
                  </StackPanel>
                </Border>
                <Border CornerRadius="8" Background="#1a1a1e" BorderBrush="#2e3035"
                        BorderThickness="1" Padding="14,12" Margin="0,0,0,4">
                  <TextBlock Foreground="#6b7280" FontSize="10.5" TextWrapping="Wrap" LineHeight="19"
                             Text="↓  Lower RAM and CPU usage&#x0a;↓  Faster startup time&#x0a;↓  No background auto-update processes&#x0a;↑  Full control via Advanced options"/>
                </Border>
              </StackPanel>
            </ScrollViewer>
            ...
            <Border Grid.Row="2" BorderBrush="#2e3035" BorderThickness="0,1,0,0"
                    Padding="24,14" CornerRadius="0,0,16,16">
              <StackPanel Orientation="Horizontal" HorizontalAlignment="Right">
                <Button x:Name="BtnAboutGithub" Content="github ↗"
                        Style="{StaticResource GhostBtn}" Height="34" Padding="18,0" Margin="0,0,8,0"/>
                <Button x:Name="BtnAboutOk" Content="OK"
                        Style="{StaticResource SuccessOkBtn}"
                        Height="34" Width="90" Padding="0"/>
              </StackPanel>
            </Border>
          </Grid>
        </Border>
...
$BtnAbout        = G "BtnAbout"
$PanelAbout      = G "PanelAbout"
$BtnCloseAbout   = G "BtnCloseAbout"
$BtnAboutOk      = G "BtnAboutOk"
$BtnAboutGithub  = G "BtnAboutGithub"
...
$BtnConsole.Add_Click({
    ...
    if ($script:ConsoleVisible) {
        [Win32Console]::ShowWindow($script:hConsole, 0) | Out-Null
        $script:ConsoleVisible = $false
        $BtnConsole.Foreground = [Windows.Media.BrushConverter]::new().ConvertFrom("#4e5058")
    } else {
        [Win32Console]::ShowWindow($script:hConsole, 5) | Out-Null
...
$BtnAbout.Add_Click({
    ...
    $PanelAbout.Visibility   = "Visible"
})
$BtnCloseAbout.Add_Click({
    $PanelAbout.Visibility   = "Collapsed"
    $ModalOverlay.Visibility = "Collapsed"
})
$BtnAboutOk.Add_Click({
    $PanelAbout.Visibility   = "Collapsed"
    $ModalOverlay.Visibility = "Collapsed"
})
$BtnAboutGithub.Add_Click({
    Start-Process "https://github.com/insovs/Discord-Optimization"
})
...
$BtnStApply.Add_Click({
    ...
    $ps.AddScript({
        ...
        $lKc="$($keys.Count) settings written"
        $rs_window.Dispatcher.Invoke([action]{
